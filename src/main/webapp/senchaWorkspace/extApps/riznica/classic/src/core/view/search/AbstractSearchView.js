Ext.define("riznica.core.view.search.AbstractSearchView", {
  ...
  requires: [
    ...
    // ,
    // "riznica.core.infrastructure.RbVtRenderUtils"
  ],
              ...
              dockedItems: [
                {
                  ...
                  items: [
                    ...
                    {
                      xtype: "button",
                      text: '<div style="color: blue">Search</div>',
                      formBind: true,
                      itemId: "btnPretrazi",
                      ...
                      handler: function (config) {
                        ...
                        // if (this.up().up().xtype == "search-order-OrderSearchView") {
                        //   var products = [];
                        //   this.up().up().down("#product").getStore().each(function(record) {
                        //     products.push(record.data.id);
                        //     // console.log("id: "+record.data.id+", title: " + record.data.title);
                        //   });

                        // delete criteria.usersCombo;
                        // criteria.products = products;
                          // console.log("product title: " + criteria.orders.title);
                        // }
                    ...
                    {
                      xtype: "button",
                      text: '<div style="color: blue">Generate report</div>',
                    ...
                    {
                      xtype: "button",
                      text: '<div style="color: blue">Clear filters</div>',
                    ...
                    {
                      xtype: "button",
                      text: '<div style="color: blue">Cancel</div>',
                      itemId: "btnOdustani",
                      scope: me,
                      style: me.formConfig.searchBarButtonStyle,
                      handler: function () {
