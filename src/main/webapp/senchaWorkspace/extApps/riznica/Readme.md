...
Applications that target a single toolkit will have the following structure.
    ...
    app/                # Contains JavaScript code
        module-name/    # Contains JavaScript code for module
            model/      # Data model classes for module
            view/       # Views as well as ViewModels and ViewControllers for module
            store/      # Data stores for module
            controller/ # Global / application-level controllers for module
...
This area is intended for overrides like these:
    ...
    Ext.define('poreznaured.overrides.foo.Bar', {
